...
class GumbelIntersection(AbstractIntersection):
    ...
    def _forward(self, box: TBoxTensor, dim=0):
        ...
        Args:
            box: First operand of the intersection
            dim: Second operand of the intersection
    ...
    def _forward_old(self, left: TBoxTensor, right: TBoxTensor) -> TBoxTensor:
        """Computes the gumbel intersection of left and right.
        ...
        return gumbel_intersection_old(
            left,
            right,
            intersection_temperature=self.intersection_temperature,
            approximation_mode=self.approximation_mode,
