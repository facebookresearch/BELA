...
from duck.common.utils import log1m, mean_over_batches, metric_dict_to_string, prefix_suffix_keys, tiny_value_of_dtype
...
class RelToBox(pl.LightningModule):
    def __init__(self, config, **kwargs):
        ...
        self.box_embedding = BoxEmbedding(
            self.num_embeddings,
            self.dim,
            box_parametrizaton=config.rel_to_box.boxes.parametrization,
            universe_idx=0
        )
